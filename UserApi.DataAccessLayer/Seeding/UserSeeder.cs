    ...
    public class UserSeeder : ISeeder<Users>
    {
        private static readonly List<Users> users = new()
        {
            new Users
            {
                ...
                PasswordHash = "hashed_password_1",  // Псевдо-хеш для прикладу
            ...
            new Users
            {
                ...
                PasswordHash = "hashed_password_2",  // Псевдо-хеш для прикладу
            ...
            new Users
            {
                ...
                PasswordHash = "hashed_password_3",  // Псевдо-хеш для прикладу
